...
int main(int argc, char **argv) {
  ...
  users[0].ip = (char *)"10.117.11.177";
  users[0].port_no = 8085;

  users[1].name = (char *)"vivek";
  users[1].ip = (char *)"10.145.142.187";
  users[1].port_no = 8084;

  users[2].name = (char *)"aayush";
  users[2].ip = (char *)"10.105.76.75";
  users[2].port_no = 8100;
  ...
  users[4].ip = (char *)"10.145.187.237";
